...
export const XTRA_SHORT_DESCRIPTIONS: {[key: string]: string} = {
  'skc': "Fair/CLEAR",
  'few': "A few clouds",
  'sct': "Partly CLOUDY",
  "bkn": "Mostly CLOUDY",
...
export const SAMPLE_BY_COORDS_REQ = {
  'data':
    {
      "@context": [
...
export const DEFAULT_LOC = {
  longitude : SAMPLE_BY_COORDS_REQ.data.geometry.coordinates[0],
  latitude : SAMPLE_BY_COORDS_REQ.data.geometry.coordinates[1]
}
...
export const DUMMY_DAYS = SAMPLE_FORECAST.data.properties.periods;
